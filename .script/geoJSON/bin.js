...
const list = {
    '610100-西安市': ['', 'Xian', '西安'],
    '610200-铜川市': ['', 'Tongchuan', '铜川'],
    '610300-宝鸡市': ['', 'Baoji', '宝鸡'],
    '610400-咸阳市': ['', 'Xianyang', '咸阳'],
    '610500-渭南市': ['', 'Weinan', '渭南'],
    '610600-延安市': ['', 'Yanan', '延安'],
    '610700-汉中市': ['', 'Hanzhong', '汉中'],
    '610800-榆林市': ['yulin-city', 'YulinCity', '榆林'],
    '610900-安康市': ['', 'Ankang', '安康'],
    '611000-商洛市': ['', 'Shangluo', '商洛'],
};
